#ifndef DRIVERS_DEVICES_e1000
#define DRIVERS_DEVICES_e1000

#include "../../net/l0/ethernet.h"

#define E1000_LINKUP_TIMEOUT 5000

network_device *e1000_init(pci_device *pci);

enum E1000_General_Registers {
    /** Device Control */
...
enum E1000_Interrupt_Registers {
...
enum E1000_Register_Bit_Address_TIPG {
    E1000_REGBITADDR_TIPG_IPGT = 0,
    E1000_REGBITADDR_TIPG_IPGR1 = 10,
    E1000_REGBITADDR_TIPG_IPGR2 = 20,
};

enum E1000_Register_Bit_Transmission_Descriptor_Command {
...
enum E1000_Register_Bit_Transmission_Descriptor_Status {
...
enum E1000_Register_Bit_Receive_Descriptor_Status {
...
enum E1000_Register_Bit_Receive_Delay_Time {
